---
title: "Mixed Models for Trust and Self Efficacy"
...
test = lme4::lmer(mean_trust_value ~ reliability + (1+ reliability|ID), data= f.df)
test2 = lme4::lmer(mean_trust_value ~ (1+ reliability|ID), data= f.df)
test3= lme4::lmer(mean_trust_value ~ reliability*exposure + (1+ reliability|ID), data= f.df)
#test3 = lme4::lmer(mean_trust_value ~ exposure + (1+ exposure|ID), data= f.df)
#test4 = lme4::lmer(mean_trust_value ~  (1+ exposure|ID), data= f.df)
...
trust.table = compare_performance(MLID.lame,MLr.lame,MLrr.lame, test, test2,test3,  MLree.lame , MLrr2.lame, MLree2.lame, MLree3.lame, rank = TRUE)
trust.table
...
```{r}
SML1.lame = lme4::lmer(SSE_1 ~ (1|ID), data = f.df)
SML2.lame = lme4::lmer(SSE_1 ~  complexity + (1|ID), data = f.df)
SML3.lame = lme4::lmer(SSE_1 ~ reliability + (reliability|ID), data = f.df) 
SML4.lame = lme4::lmer(SSE_1 ~ reliability + exposure + (reliability|ID), data = f.df) 
SML45.lame = lme4::lmer(SSE_1 ~ reliability*exposure + (reliability|ID), data = f.df) 
SML5.lame = lme4::lmer(SSE_1 ~ reliability*exposure + complacency_value + (reliability|ID),data = f.df)
SML6.lame = lme4::lmer(SSE_1 ~ reliability*exposure + efficacy_value + (reliability|ID),data = f.df)
SML7.lame = lme4::lmer(SSE_1 ~ reliability*exposure + efficacy_value*complacency_value + (reliability|ID),data = f.df)
...
SBEST.lame = lme4::lmer(SSE_1 ~ reliability*exposure + efficacy_value*complacency_value + (reliability|ID),data = f.df)
...
BEST.lame = lme4::lmer(mean_trust_value ~ reliability + (reliability|ID),
   data = f.df) #lowest AIC and lowest RMSE and highest R^2
